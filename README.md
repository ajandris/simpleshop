...
A **visitor** can browse and search shop and items.
...
# Development
This part is dedicated to the shop's development.
## Development process
...
| US7           | Site User | Receive verification requests in email    | Verify that I have not misspelled email.                                          |
...
| User Story ID | As a/an | I want to be able to…                       | So that I can…                                                                 |
|---------------|---------|---------------------------------------------|---------------------------------------------------------------------------------|
| US9           | Shopper | Filter by a specific category of product    | Find the best-priced in a specific category |
| US10          | Shopper | Search for a product by name or description | Find a specific product I'd like to purchase                                   |

#### Purchasing and Checkout

| User Story ID | As a/an | I want to be able to…                             | So that I can…                                                            |
|---------------|---------|---------------------------------------------------|---------------------------------------------------------------------------|
| US11          | Shopper | Easily select quantity of a product               | Ensure I don't accidentally select the wrong product, quantity, or size   |
| US12          | Shopper | View items in my bag                              | Identify the total cost and all items I will receive                      |
| US13          | Shopper | Adjust the quantity of individual items in my bag | Easily make changes to my purchase before checkout                        |
| US14          | Shopper | Add, delete and edit favourite addresses          | Save time by just selecting delivery and billing addrress before checkout |
| US15          | Shopper | Easily enter my payment information               | Check out quickly and with no hassles                                     |
| US16          | Shopper | Feel my personal and payment information is safe  | Confidently provide the needed information to make a purchase             |
| US17          | Shopper | View an order confirmation after checkout         | Verify that I haven't made any mistakes                                   |
| US18          | Shopper | Receive an email confirmation after checking out  | Keep the confirmation of what I've purchased for my records               |

#### Admin and Store Management

| User Story ID | As a/an     | I want to be able to…        | So that I can…                                           |
|---------------|-------------|-------------------------------|-----------------------------------------------------------|
| US19          | Store Owner | Add a product                 | Add new items to my store                                 |
| US20          | Store Owner | Edit/update a product         | Change product prices, descriptions, images, and criteria |
| US21          | Store Owner | Delete a product              | Remove items that are no longer for sale                  |
...
* page background: #F5F0E6
* header area above menu: #F5F0E6
* Menu background: #795548
* Footer background: #f3e0d1
* Fonts: black

**Behavioural colours**

* Active menu item: font - bold, black, background - #F5F0E6
* buttons: transparent, black or red depending on usage, other buttons hover: light-gray
...
Automated tests are used for calculations only (cart, order) in a TDD (test driven development) manner - 
make tests first, code after.
...
The Stripe keys are copied from the <a href="https://stripe.com">Stripe</a> Sandbox environment (test keys).
The RaCaPtChA keys are configured and copied from 
<a href="https://docs.cloud.google.com/recaptcha/docs/overview">the Google</a> 
...
* Unzip candlemania files into &lt;project root&gt;
...
# Next steps
While this is a fictional shop, it can become real. The possible next steps for the site's idea to evolve 
