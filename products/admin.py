...
class ProductResource(resources.ModelResource):
    ...
    short_description = fields.Field(
        attribute="short_description", column_name="short_description"
    )
    tags = fields.Field(attribute="tags", column_name="tags")
    price = fields.Field(attribute="price", column_name="price")
    sales_price = fields.Field(
        attribute="sales_price", column_name="sales_price"
    )
    image = fields.Field(
        attribute="image",
...
class ImagesResource(resources.ModelResource):
    ...
    inserted_at = fields.Field(
        attribute="inserted_at", column_name="inserted_at"
    )
...
class CategoryResource(resources.ModelResource):
    ...
    is_featured = fields.Field(
        attribute="is_featured", column_name="is_featured"
    )
    description = fields.Field(
        attribute="description", column_name="description"
    )
...
class ProductImagesResource(resources.ModelResource):
    ...
    number_in_gallery = fields.Field(
        attribute="number_in_gallery", column_name="Sequence"
    )
